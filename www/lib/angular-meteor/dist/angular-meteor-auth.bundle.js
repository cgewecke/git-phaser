...
////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                      //
angular.module('angular-meteor.auth', ['angular-meteor']).service('$auth', ['$rootScope', '$q', function ($rootScope, $q) {
  var _this = this;                                                                                   //
                                                                                                      //
  ...
  this.getUserInfo = function () {                                                                    // 71
    return {                                                                                          // 72
      ...
      loggingIn: Meteor.loggingIn()                                                                   // 75
                                                                                                      ...
                                                                                                      //
  this._throttledDigest = function () {                                                               // 79
    var isDigestable = !$rootScope.$$destroyed && !$rootScope.$$phase;                                // 80
                                                                                                      //
    if (isDigestable) $rootScope.$digest();                                                           // 84
  };                                                                                                  //
}]).run(['$rootScope', '$auth', '$reactive', function ($rootScope, $auth, Reactive) {                 //
  Tracker.autorun(function () {                                                                       // 95
    var scopeProto = Object.getPrototypeOf($rootScope);                                               // 96
    var userInfo = $auth.getUserInfo();                                                               // 97
    _.extend(scopeProto, { $auth: userInfo });                                                        // 98
    _.extend(Reactive, { auth: userInfo });                                                           // 99
  });                                                                                                 //
}]);                                                                                                  //
////////////////////////////////////////////////////////////////////////////////////////////////////////
