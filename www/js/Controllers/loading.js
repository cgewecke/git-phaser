angular.module('gitphaser').controller('LoadingController', LoadingCtrl);
/**
 * @ngdoc object
 * @module  gitphaser
 * @name  gitphaser.object:LoadingCtrl
 * @description  Controller for the default/otherwise route. Waits for platform ready,
